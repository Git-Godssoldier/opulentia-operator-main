...
export class Env {
    ...
    public async get(instanceId: string, requestOptions?: Env.RequestOptions): Promise<Scrapybara.EnvGetResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `instance/${encodeURIComponent(instanceId)}/env`,
            ),
            method: "GET",
            headers: {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling GET /instance/{instance_id}/env.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
    ...
    public async set(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/env.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
    ...
    public async delete(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/env/delete`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/env/delete.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
