...
export class Notebook {
    ...
    public async listKernels(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `instance/${encodeURIComponent(instanceId)}/notebook/kernels`,
            ),
            method: "GET",
            headers: {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling GET /instance/{instance_id}/notebook/kernels.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
    ...
    public async create(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/notebook/create`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/notebook/create.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
    ...
    public async get(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/notebook/${encodeURIComponent(notebookId)}`,
            ),
            method: "GET",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling GET /instance/{instance_id}/notebook/{notebook_id}.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
    ...
    public async delete(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/notebook/${encodeURIComponent(notebookId)}/delete`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/notebook/{notebook_id}/delete.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
    ...
    public async addCell(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/notebook/${encodeURIComponent(notebookId)}/cell`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/notebook/{notebook_id}/cell.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
    ...
    public async executeCell(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/notebook/${encodeURIComponent(notebookId)}/cell/${encodeURIComponent(cellId)}/execute`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/notebook/{notebook_id}/cell/{cell_id}/execute.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
    ...
    public async execute(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.ScrapybaraEnvironment.Production,
                `instance/${encodeURIComponent(instanceId)}/notebook/${encodeURIComponent(notebookId)}/execute`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.ScrapybaraTimeoutError(
                    "Timeout exceeded when calling POST /instance/{instance_id}/notebook/{notebook_id}/execute.",
                );
            case "unknown":
                throw new errors.ScrapybaraError({
                    message: _response.error.errorMessage,
